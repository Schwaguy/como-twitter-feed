 ...
 class TweetPHP {
    ...
    public function  __construct ($options = array()) {
      ...
      if (!$this->tweet_found) {
        ...
        $html = str_replace('{link}',  'https://twitter.com/' . $this->options['twitter_screen_name'], $this->options['error_template']);
    ...
    private function parse_tweet ($tweet) {
      ...
      // Format tweet text
      $tweet_text_raw = shorten_tweet($tweet['text'], $this->options['tweet_length'], '', true);
